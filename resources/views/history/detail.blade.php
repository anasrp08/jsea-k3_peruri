            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>No. JSEA</b>
                    <a class="float-right" id='no_jsea'>asdasds</a> 
                  </li>
                  <li class="list-group-item">
                    <b>Tanggal Dibuat</b> <a class="float-right" id='tgl_dibuat'>-</a>
                  </li>
                  <li class="list-group-item">
                    <b>Tanggal Updated</b> <a class="float-right" id='tgl_updated'>-</a>
                  </li>
                  <li class="list-group-item">
                    <b>Dokumen JSEA</b>
                  ...
                  <li class="list-group-item">
                    <b>Tanggal Dikirim</b> <a class="float-right" id='tgl_dikirim'>13,287</a>
                  </li>
                  <li class="list-group-item">
